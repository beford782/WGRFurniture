...
STORE = {
    ...
    "Page Title (ES)": "DreamFinder - Cuestionario del Sueño de WG&R Furniture",
    "Meta Description (ES)": "Responde el cuestionario de WG&R Sleep Shop y recibe recomendaciones personalizadas de colchones.",
    "OG Title (ES)": "DreamFinder - WG&R Furniture",
    "Trust Signal (ES)": "Sirviendo a Northeast Wisconsin desde 1946 — con orgullo, propiedad de sus empleados",
    "Heritage (ES)": "PROPIEDAD DE SUS EMPLEADOS · NORTHEAST WISCONSIN · DESDE 1946",
    "Email Privacy (ES)": "Solo usaremos tu correo para enviarte tus resultados.",
    "Privacy Policy Contact (ES)": "",
    "In-Stock Text (ES)": "En stock en WG&R",
    "Email Header (ES)": "",
    "Email Subtext (ES)": "",
    "Location Label (ES)": "Northeast Wisconsin",
    ...
    "Voice Eyebrow (ES)": "PROPIEDAD DE SUS EMPLEADOS · NORTHEAST WISCONSIN · DESDE 1946",
    "Voice Headline Main (ES)": "Northeast Wisconsin,",
    "Voice Headline Accent (ES)": "tu tienda del descanso.",
    "Voice Sub-Copy Before (ES)": "Responde unas preguntas y revisa tus opciones de colchón con un especialista del descanso de WG&R.",
    "Voice Sub-Copy Accent (ES)": "",
    "Voice Sub-Copy After (ES)": "",
    "Voice CTA Primary (ES)": "Encontrar Mi Opción Ideal",
    "Voice Time Estimate (ES)": "Aproximadamente 2 minutos · Sin presión",
